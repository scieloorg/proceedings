<?php
include_once(dirname(__FILE__)."/old2new.inc");
...
{ 
	...
	{
		call_user_func_array(array($this, 'ScieloXMLTransformer'), func_get_args());
	}
...
class ScieloDocReader extends docReader
{
	...
	function __construct()
	{
		call_user_func_array(array($this, 'ScieloDocReader'), func_get_args());
	}
