...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<xsl:otherwise>
				<xsl:call-template name="ShowNavBarButton">
					...
					<xsl:with-param name="alttext">
						<xsl:choose>
							<xsl:when test="//CONTROLINFO/LANGUAGE='en'">available event numbers</xsl:when>
							<xsl:when test="//CONTROLINFO/LANGUAGE='es'">números de eventos disponibles</xsl:when>
							<xsl:when test="//CONTROLINFO/LANGUAGE='pt'">números de eventos disponíveis</xsl:when>
						</xsl:choose>
					</xsl:with-param>
		...
		<xsl:call-template name="ShowNavBarButtonIAH">
			...
			<xsl:with-param name="alttext">
				<xsl:choose>
					...
					<xsl:when test="//CONTROLINFO/LANGUAGE='es'">búsqueda de trabajos</xsl:when>
					<xsl:when test="//CONTROLINFO/LANGUAGE='pt'">pesquisa de trabalhos</xsl:when>
				</xsl:choose>
			</xsl:with-param>
			<xsl:with-param name="scope" select="$scope"/>
		</xsl:call-template>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:call-template name="ShowNavBarButton">
					...
					<xsl:with-param name="alttext">
						<xsl:choose>
							<xsl:when test="//CONTROLINFO/LANGUAGE='en'">alphabetic event listing</xsl:when>
							<xsl:when test="//CONTROLINFO/LANGUAGE='es'">lista alfabética de eventos</xsl:when>
							<xsl:when test="//CONTROLINFO/LANGUAGE='pt'">lista alfabética de eventos</xsl:when>
						</xsl:choose>
					</xsl:with-param>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:call-template name="ShowNavBarButton">
					...
					<xsl:with-param name="alttext">
						<xsl:choose>
							<xsl:when test="//CONTROLINFO/LANGUAGE='en'">subject list of events</xsl:when>
	...
	<xsl:template name="FORMSERIALS">
		<xsl:call-template name="ShowNavBarButtonIAH">
			...
			<xsl:with-param name="alttext">
				<xsl:choose>
					<xsl:when test="//CONTROLINFO/LANGUAGE='en'">event search</xsl:when>
