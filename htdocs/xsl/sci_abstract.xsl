		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<xsl:call-template name="GetStrip">
						<xsl:with-param name="strip" select="CONTROLINFO/CURRENTISSUE/@VOL"/>
			...
			<body>
				<div class="container">
					...
					<div class="content">
						...
						<h2>
							<xsl:apply-templates select="ARTICLE/ISSUEINFO/STRIP" mode="titlegroup"/>
						</h2>
						<h2 id="printISSN">
					...
					<div class="footer">
						<xsl:apply-templates select=".//ISSUEINFO/COPYRIGHT"/>
						<xsl:apply-templates select=".//ISSUEINFO/CONTACT"/>
					</div>
				</div>
			</body>
		</html>
