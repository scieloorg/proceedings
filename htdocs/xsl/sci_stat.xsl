...
<xsl:apply-templates select="document(concat('../xml/',//CONTROLINFO/LANGUAGE,'/sci_stat.xml'))//text"/>
									...
									<ul>
										<li>
											<a href="/site_usage/reports/scielobr-1998.htm">1998</a>
										</li>
										<li>
											<a href="/site_usage/reports/scielobr-1999.htm">1999</a>
										</li>
										<li>
											<a href="/site_usage/reports/scielobr-2000.htm">2000</a>
										</li>
										<li>
						2001 
						<xsl:choose>
									...
									<ul>
										<li>
											<a href="http://www.scielo.br/site_usage/scieloBR-2002.htm">2002</a>
										</li>
										<li>
											<a href="http://www.scielo.br/site_usage/scieloBR-2003.htm">2003</a>
										</li>
										<li>
											<a href="http://www.scielo.br/site_usage/scieloBR-2004.htm">2004</a>
										</li>
										<li>
											<a href="http://www.scielo.br/site_usage/scieloBR-2005.htm">2005-server1</a>
										</li>
										<li>
											<a href="http://www.scielo.br/site_usage/scielo2BR-2005.htm">2005-server2</a>
										</li>
										<li>
											<a href="http://logs.bireme.br/cgi-bin/awstats.pl?config=scieloBR">2006-server1</a>
										</li>
										<li>
											<a href="http://logs.bireme.br/cgi-bin/awstats.pl?config=scielo2BR">2006-server2</a>
										</li>
									</ul-->
									<li>
										<a>
