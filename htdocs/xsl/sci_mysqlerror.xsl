							...
							<xsl:choose>
								<xsl:when test="CONTROLINFO/LANGUAGE='en'">
									...
									<font face="verdana" size="2" color="black">
										<b>Error:&#160;<xsl:value-of select="ERRORCODE"/>
										</b>
									</font>
									<br/>
									<br/>
									<font face="verdana" size="2" color="#800000">
					Click on the SciELO logo to browse the SciELO Library or use the browser "BACK" button to return to the previous page.<br/>
										<br/>Please feel free to email us your questions, comments or concerns using the link below.
				</font>
								</xsl:when>
								<xsl:when test="CONTROLINFO/LANGUAGE='pt'">
									...
									<br/>
									<font face="verdana" size="2" color="black">
										<b>Erro:&#160;<xsl:value-of select="ERRORCODE"/>
										</b>
									</font>
									<br/>
									<br/>
									<font face="verdana" size="2" color="#800000">
					Clique no logo da SciELO para visualizar a Biblioteca SciELO ou use o botão "BACK" do browser para voltar à página anterior.<br/>
										<br/>Por favor envie-nos um email com suas perguntas, comentários ou sugestões usando o link abaixo.				</font>
								</xsl:when>
								<xsl:when test="CONTROLINFO/LANGUAGE='es'">
									...
									<br/>
									<font face="verdana" size="2" color="#800000">
					Clique en el logo de SciELO para revisar la Biblioteca SciELO o use el botón "BACK" del visualizador para volver a la página anterior.<br/>
										<br/>Agradeceríamos que nos enviaran emails con cualquier pregunta, comentario o sugerencia usando el link que aparece a continuación.
				</font>
								</xsl:when>
							</xsl:choose>
						</td>
