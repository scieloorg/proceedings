...
call batch/GeraIsoBool.bat $1/bases/artigo/artigo "TP=h" temp/transf2medline/artigo.iso prc/addEventData.prc
rem call batch/GeraIsoBool.bat $1/bases/artigo/artigo "TP=c" temp/transf2medline/bib4cit.iso prc/bib4cit.prc

rem call batch/InformaLog.bat $0 x FTP artigo e bib4cit
rem ftp -n <$2 >> $INFORMALOG
rem batch/ifErrorLevel.bat $? batch/AchouErro.bat $0 ftp: $2
