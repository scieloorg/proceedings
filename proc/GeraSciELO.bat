...
rem para formulario de pesquisa em issue
call batch/GeraInvertido.bat ../bases-work/issue/issue fst/isssrc.fst ../bases-work/issue/search
call batch/GeraInvertido.bat ../bases-work/issue/issue fst/isssrcp.fst ../bases-work/issue/searchp
